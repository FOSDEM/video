...
fontsize: "9pt"
---
| Video buildup checklist for room aw1120** |
| --- |
|`[ ]` Bring equipment to room aw1120|
|`[ ]` Unpack tripod|
|`[ ]` Place tripod at "diagonal from room entrance"|
|`[ ]` Level tripod|
...
Suggested route for XLR and network cable is as follows: along the far wall from the door
