...
fontsize: "9pt"
---
| Video buildup checklist for room h2214** |
| --- |
|`[ ]` Bring equipment to room h2214|
|`[ ]` Unpack tripod|
|`[ ]` Place tripod at "diagonal from the room door"|
|`[ ]` Level tripod|
...
Suggested route for XLR and network cable is as follows: along the wall opposite the door
