...
fontsize: "9pt"
---
| Video buildup checklist for room ud6215** |
| --- |
|`[ ]` Bring equipment to room ud6215|
|`[ ]` Unpack tripod|
|`[ ]` Place tripod at "Unknown, completely new room"|
|`[ ]` Level tripod|
...
Suggested route for XLR and network cable is as follows: Unknown, completely new room
