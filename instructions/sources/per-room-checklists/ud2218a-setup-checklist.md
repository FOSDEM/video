...
fontsize: "9pt"
---
| Video buildup checklist for room ud2218a** |
| --- |
|`[ ]` Bring equipment to room ud2218a|
|`[ ]` Unpack tripod|
|`[ ]` Place tripod at "in the middle at the back"|
|`[ ]` Level tripod|
...
Suggested route for XLR and network cable is as follows: Along the right wall (without windows) when looking from the stage. The cables can be taped directly to the wall in order not to be on the stairs.
