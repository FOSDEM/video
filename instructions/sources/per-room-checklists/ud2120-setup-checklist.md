...
fontsize: "9pt"
---
| Video buildup checklist for room ud2120** |
| --- |
|`[ ]` Bring equipment to room ud2120|
|`[ ]` Unpack tripod|
|`[ ]` Place tripod at "close to the windows, at the back of the room, near the emergency exit"|
|`[ ]` Level tripod|
...
Suggested route for XLR and network cable is as follows: on the floor directly under the windows, next to the leftmost seats; very little taping needed
